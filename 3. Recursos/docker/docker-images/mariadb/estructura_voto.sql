...
CREATE TABLE IF NOT EXISTS `opciones` (
  ...
  `id_pregunta` varchar(150) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `resultados` (
  ...
  `id_encuesta` varchar(150) NOT NULL,
  `email` varchar(50) COLLATE utf8mb4_spanish2_ci NOT NULL,
...
CREATE USER 'adminappvoting'@'%' IDENTIFIED BY '13Ao^W%UIFTc';
GRANT ALL PRIVILEGES ON voto.* TO 'adminappvoting'@'%';
